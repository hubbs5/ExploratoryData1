...
#Create Histogram
bin = seq(0,6,by = 0.5) #Define number of bins
t_h = "Global Active Power" #Set the title
x_lh = "Global Active Power (kilowatts)" #Set the x-axis label
y_lh = "Frequency"
hist(data$Global_active_power, ylim = c(0,1200), main = paste(t_h),
     ylab = y_lh, xlab = x_lh, col ="red", plot = TRUE)
